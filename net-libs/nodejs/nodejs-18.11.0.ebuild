...
inherit bash-completion-r1 check-reqs flag-o-matic linux-info pax-utils python-any-r1 toolchain-funcs xdg-utils ninja-utils
...
src_prepare() {
	...
	sed -i -e "/'-latomic'/d" node.gyp || die
